...
function MatchingPResynth.kr(dict,method,trigger,residual,activs)
	method=method or 0;residual=residual or 0;
...
function MCLDChaosGen.create()
		return MCLDChaosGen:MultiNew{2}
end
...
function WidthFirstUGen.create()
		return WidthFirstUGen:MultiNew{2}
end
...
function PV_CommonMul.create()
		return PV_CommonMul:MultiNew{1}
end
...
function PV_ChainUGen.create()
		return PV_ChainUGen:MultiNew{2}
end
...
function BFGrainPanner.create()
		return BFGrainPanner:MultiNew{2}
end
